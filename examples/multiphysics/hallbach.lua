...
for i = 0, Magnet.count_outer - 1 do
  ...
  table.insert(cap_outer_magnets,
    box(Magnet.size - Config.tolerance, Magnet.size - Config.tolerance, Ring.cutout_height - Config.tolerance):center("XYZ")
    :rotate(0, 0, rotation + angle_deg)
...
MotorHolder.model = difference(
  box(Motor.width + 2 * Motor.wall, Motor.width + 2 * Motor.wall, Motor.height + Motor.insert_height):center("XYZ"),
